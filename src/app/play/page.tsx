...
export default function PlayPage() {
  ...
  return (
    <main className="min-h-dvh notebook-paper flex flex-col items-center justify-start py-4 px-4 sm:px-6 pb-safe select-none relative overflow-hidden">
      ...
      <header className="w-full max-w-2xl flex items-center justify-between py-2 px-3 mb-2 z-10">
        <div className="flex items-center gap-2 sm:gap-3">
          <Image
            ...
            height={75}
            priority
            className="h-9 sm:h-14 max-w-[55vw] w-auto object-contain drop-shadow-sm brightness-200"
          />
        </div>
